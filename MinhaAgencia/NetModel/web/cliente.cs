...
namespace GeneXus.Programs {
   public class cliente : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 FormCell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtClienteSobreNome_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtClienteSobreNome_Internalname, "Sobre Nome", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtClienteSobreNome_Internalname, StringUtil.RTrim( A3ClienteSobreNome), StringUtil.RTrim( context.localUtil.Format( A3ClienteSobreNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteSobreNome_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClienteSobreNome_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "SobreNome", "left", true, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtClienteEndereco_Internalname, A4ClienteEndereco, "http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4ClienteEndereco), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", 0, 1, edtClienteEndereco_Enabled, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "", "1024", -1, 0, "_blank", "", 0, true, "GeneXus\\Address", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtClienteTelefone_Internalname, StringUtil.RTrim( A5ClienteTelefone), StringUtil.RTrim( context.localUtil.Format( A5ClienteTelefone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", gxphoneLink, "", "", "", edtClienteTelefone_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClienteTelefone_Enabled, 0, "tel", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, 0, true, "GeneXus\\Phone", "left", true, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtClienteEmail_Internalname, A6ClienteEmail, StringUtil.RTrim( context.localUtil.Format( A6ClienteEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "mailto:"+A6ClienteEmail, "", "", "", edtClienteEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClienteEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "GeneXus\\Email", "left", true, "", "HLP_Cliente.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z3ClienteSobreNome = cgiGet( "Z3ClienteSobreNome");
            ...
            AssignAttri("", false, "A3ClienteSobreNome", A3ClienteSobreNome);
      ...
      protected void ZM011( short GX_JID )
      {
         if ( ( GX_JID == 2 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z2ClienteNome = T00013_A2ClienteNome[0];
               Z3ClienteSobreNome = T00013_A3ClienteSobreNome[0];
            ...
            else
            {
               ...
               Z3ClienteSobreNome = A3ClienteSobreNome;
      ...
      protected void Load011( )
      {
         ...
         {
            RcdFound1 = 1;
            A2ClienteNome = T00014_A2ClienteNome[0];
            AssignAttri("", false, "A2ClienteNome", A2ClienteNome);
            A3ClienteSobreNome = T00014_A3ClienteSobreNome[0];
            AssignAttri("", false, "A3ClienteSobreNome", A3ClienteSobreNome);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A1ClienteId", StringUtil.LTrimStr( (decimal)(A1ClienteId), 4, 0));
            A2ClienteNome = T00013_A2ClienteNome[0];
            AssignAttri("", false, "A2ClienteNome", A2ClienteNome);
            A3ClienteSobreNome = T00013_A3ClienteSobreNome[0];
            AssignAttri("", false, "A3ClienteSobreNome", A3ClienteSobreNome);
      ...
      protected void CheckOptimisticConcurrency011( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z2ClienteNome, T00012_A2ClienteNome[0]) != 0 ) || ( StringUtil.StrCmp(Z3ClienteSobreNome, T00012_A3ClienteSobreNome[0]) != 0 ) || ( StringUtil.StrCmp(Z4ClienteEndereco, T00012_A4ClienteEndereco[0]) != 0 ) || ( StringUtil.StrCmp(Z5ClienteTelefone, T00012_A5ClienteTelefone[0]) != 0 ) || ( StringUtil.StrCmp(Z6ClienteEmail, T00012_A6ClienteEmail[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z2ClienteNome, T00012_A2ClienteNome[0]) != 0 )
               {
                  GXUtil.WriteLog("cliente:[seudo value changed for attri]"+"ClienteNome");
                  GXUtil.WriteLogRaw("Old: ",Z2ClienteNome);
                  GXUtil.WriteLogRaw("Current: ",T00012_A2ClienteNome[0]);
               }
               if ( StringUtil.StrCmp(Z3ClienteSobreNome, T00012_A3ClienteSobreNome[0]) != 0 )
               {
                  GXUtil.WriteLog("cliente:[seudo value changed for attri]"+"ClienteSobreNome");
                  GXUtil.WriteLogRaw("Old: ",Z3ClienteSobreNome);
                  GXUtil.WriteLogRaw("Current: ",T00012_A3ClienteSobreNome[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00019 */
                     pr_default.execute(7, new Object[] {A2ClienteNome, A3ClienteSobreNome, A4ClienteEndereco, A5ClienteTelefone, A6ClienteEmail, A1ClienteId});
                     pr_default.close(7);
                     dsDefault.SmartCacheProvider.SetUpdated("Cliente");
      ...
      protected void DisableAttributes011( )
      {
         ...
         edtClienteSobreNome_Enabled = 0;
         AssignProp("", false, edtClienteSobreNome_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtClienteSobreNome_Enabled), 5, 0), true);
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z3ClienteSobreNome", StringUtil.RTrim( Z3ClienteSobreNome));
      ...
      public void Valid_Clienteid( )
      {
         ...
         AssignAttri("", false, "A3ClienteSobreNome", StringUtil.RTrim( A3ClienteSobreNome));
         AssignAttri("", false, "A4ClienteEndereco", A4ClienteEndereco);
         AssignAttri("", false, "A5ClienteTelefone", StringUtil.RTrim( A5ClienteTelefone));
         AssignAttri("", false, "A6ClienteEmail", A6ClienteEmail);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_CLIENTEID",",oparms:[{av:'A2ClienteNome',fld:'CLIENTENOME',pic:''},{av:'A3ClienteSobreNome',fld:'CLIENTESOBRENOME',pic:''},{av:'A4ClienteEndereco',fld:'CLIENTEENDERECO',pic:''},{av:'A5ClienteTelefone',fld:'CLIENTETELEFONE',pic:''},{av:'A6ClienteEmail',fld:'CLIENTEEMAIL',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'Z1ClienteId'},{av:'Z2ClienteNome'},{av:'Z3ClienteSobreNome'},{av:'Z4ClienteEndereco'},{av:'Z5ClienteTelefone'},{av:'Z6ClienteEmail'},{ctrl:'BTN_DELETE',prop:'Enabled'},{ctrl:'BTN_ENTER',prop:'Enabled'}]}");
      ...
      public override void initialize( )
      {
         ...
         T00014_A3ClienteSobreNome = new string[] {""} ;
         ...
         T00013_A2ClienteNome = new string[] {""} ;
         T00013_A3ClienteSobreNome = new string[] {""} ;
         ...
         T00012_A2ClienteNome = new string[] {""} ;
         T00012_A3ClienteSobreNome = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.cliente__default(),
            new Object[][] {
                new Object[] {
               T00012_A1ClienteId, T00012_A2ClienteNome, T00012_A3ClienteSobreNome, T00012_A4ClienteEndereco, T00012_A5ClienteTelefone, T00012_A6ClienteEmail
               }
               , new Object[] {
               T00013_A1ClienteId, T00013_A2ClienteNome, T00013_A3ClienteSobreNome, T00013_A4ClienteEndereco, T00013_A5ClienteTelefone, T00013_A6ClienteEmail
               }
               , new Object[] {
               T00014_A1ClienteId, T00014_A2ClienteNome, T00014_A3ClienteSobreNome, T00014_A4ClienteEndereco, T00014_A5ClienteTelefone, T00014_A6ClienteEmail
               }
               , new Object[] {
               T00015_A1ClienteId
               }
      ...
      private int edtClienteSobreNome_Enabled ;
      ...
      private string Z3ClienteSobreNome ;
      ...
      private string ZZ3ClienteSobreNome ;
      private string ZZ5ClienteTelefone ;
      ...
      private string ZZ4ClienteEndereco ;
      private string ZZ6ClienteEmail ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] T00014_A1ClienteId ;
      private string[] T00014_A2ClienteNome ;
      private string[] T00014_A3ClienteSobreNome ;
      ...
      private string[] T00013_A2ClienteNome ;
      private string[] T00013_A3ClienteSobreNome ;
      ...
      private string[] T00012_A2ClienteNome ;
      private string[] T00012_A3ClienteSobreNome ;
   ...
   public class cliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00012", "SELECT [ClienteId], [ClienteNome], [ClienteSobreNome], [ClienteEndereco], [ClienteTelefone], [ClienteEmail] FROM [Cliente] WITH (UPDLOCK) WHERE [ClienteId] = @ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00012,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00013", "SELECT [ClienteId], [ClienteNome], [ClienteSobreNome], [ClienteEndereco], [ClienteTelefone], [ClienteEmail] FROM [Cliente] WHERE [ClienteId] = @ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00013,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00014", "SELECT TM1.[ClienteId], TM1.[ClienteNome], TM1.[ClienteSobreNome], TM1.[ClienteEndereco], TM1.[ClienteTelefone], TM1.[ClienteEmail] FROM [Cliente] TM1 WHERE TM1.[ClienteId] = @ClienteId ORDER BY TM1.[ClienteId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00014,100, GxCacheFrequency.OFF ,true,false )
