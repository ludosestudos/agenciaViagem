...
namespace GeneXus.Programs {
   public class gx0010 : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8cClienteSobreNome = GetPar( "cClienteSobreNome");
               AV9cClienteTelefone = GetPar( "cClienteTelefone");
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cClienteId, AV7cClienteNome, AV8cClienteSobreNome, AV9cClienteTelefone, AV10cClienteEmail) ;
            ...
            {
               AV11pClienteId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV11pClienteId", StringUtil.LTrimStr( (decimal)(AV11pClienteId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20234212275430", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV11pClienteId,4,0))}, new string[] {"pClienteId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCCLIENTENOME", StringUtil.RTrim( AV7cClienteNome));
         GxWebStd.gx_hidden_field( context, "GXH_vCCLIENTESOBRENOME", StringUtil.RTrim( AV8cClienteSobreNome));
         GxWebStd.gx_hidden_field( context, "GXH_vCCLIENTETELEFONE", StringUtil.RTrim( AV9cClienteTelefone));
         ...
         GxWebStd.gx_hidden_field( context, "vPCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11pClienteId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, "CLIENTESOBRENOMEFILTERCONTAINER_Class", StringUtil.RTrim( divClientesobrenomefiltercontainer_Class));
      ...
      {
         return formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV11pClienteId,4,0))}, new string[] {"pClienteId"})  ;
      }
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclienteidfilter_Internalname, "Cliente Id", "", "", lblLblclienteidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCclienteid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cClienteId), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCclienteid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cClienteId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cClienteId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclienteid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclienteid_Visible, edtavCclienteid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclientenomefilter_Internalname, "Cliente Nome", "", "", lblLblclientenomefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCclientenome_Internalname, StringUtil.RTrim( AV7cClienteNome), StringUtil.RTrim( context.localUtil.Format( AV7cClienteNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclientenome_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclientenome_Visible, edtavCclientenome_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divClientesobrenomefiltercontainer_Internalname, 1, 0, "px", 0, "px", divClientesobrenomefiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclientesobrenomefilter_Internalname, "Cliente Sobre Nome", "", "", lblLblclientesobrenomefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCclientesobrenome_Internalname, "Cliente Sobre Nome", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'',false,'" + sGXsfl_64_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCclientesobrenome_Internalname, StringUtil.RTrim( AV8cClienteSobreNome), StringUtil.RTrim( context.localUtil.Format( AV8cClienteSobreNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclientesobrenome_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclientesobrenome_Visible, edtavCclientesobrenome_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclientetelefonefilter_Internalname, "Cliente Telefone", "", "", lblLblclientetelefonefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCclientetelefone_Internalname, StringUtil.RTrim( AV9cClienteTelefone), StringUtil.RTrim( context.localUtil.Format( AV9cClienteTelefone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclientetelefone_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclientetelefone_Visible, edtavCclientetelefone_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, 0, true, "", "left", true, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclienteemailfilter_Internalname, "Cliente Email", "", "", lblLblclienteemailfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15071_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCclienteemail_Internalname, AV10cClienteEmail, StringUtil.RTrim( context.localUtil.Format( AV10cClienteEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclienteemail_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclienteemail_Visible, edtavCclienteemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "", "left", true, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( Grid1Container.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Sobre Nome") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A2ClienteNome));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtClienteNome_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A3ClienteSobreNome));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A5ClienteTelefone));
               Grid1Container.AddColumnProperties(Grid1Column);
         ...
         if ( wbEnd == 64 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A3ClienteSobreNome = cgiGet( edtClienteSobreNome_Internalname);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Cclientesobrenome Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCLIENTESOBRENOME"), AV8cClienteSobreNome) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cclientetelefone Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCLIENTETELEFONE"), AV9cClienteTelefone) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        string AV8cClienteSobreNome ,
                                        string AV9cClienteTelefone ,
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cClienteNome = StringUtil.PadR( StringUtil.RTrim( AV7cClienteNome), 20, "%");
            lV8cClienteSobreNome = StringUtil.PadR( StringUtil.RTrim( AV8cClienteSobreNome), 30, "%");
            lV9cClienteTelefone = StringUtil.PadR( StringUtil.RTrim( AV9cClienteTelefone), 20, "%");
            lV10cClienteEmail = StringUtil.Concat( StringUtil.RTrim( AV10cClienteEmail), "%", "");
            /* Using cursor H00072 */
            pr_default.execute(0, new Object[] {AV6cClienteId, lV7cClienteNome, lV8cClienteSobreNome, lV9cClienteTelefone, lV10cClienteEmail, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_64_idx), 4, 0), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A6ClienteEmail = H00072_A6ClienteEmail[0];
               A5ClienteTelefone = H00072_A5ClienteTelefone[0];
               A3ClienteSobreNome = H00072_A3ClienteSobreNome[0];
               A2ClienteNome = H00072_A2ClienteNome[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEID"+"_"+sGXsfl_64_idx, GetSecureSignedToken( sGXsfl_64_idx, context.localUtil.Format( (decimal)(A1ClienteId), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV10cClienteEmail = StringUtil.Concat( StringUtil.RTrim( AV10cClienteEmail), "%", "");
         /* Using cursor H00073 */
         pr_default.execute(1, new Object[] {AV6cClienteId, lV7cClienteNome, lV8cClienteSobreNome, lV9cClienteTelefone, lV10cClienteEmail});
      ...
      protected void STRUP070( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8cClienteSobreNome = cgiGet( edtavCclientesobrenome_Internalname);
            AssignAttri("", false, "AV8cClienteSobreNome", AV8cClienteSobreNome);
            AV9cClienteTelefone = cgiGet( edtavCclientetelefone_Internalname);
            AssignAttri("", false, "AV9cClienteTelefone", AV9cClienteTelefone);
      ...
      protected void E17072( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Seleção %1", "Cliente", "", "", "", "", "", "", "", "");
      ...
      protected void E19072( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV11pClienteId = A1ClienteId;
         AssignAttri("", false, "AV11pClienteId", StringUtil.LTrimStr( (decimal)(AV11pClienteId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV11pClienteId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV11pClienteId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV11pClienteId", StringUtil.LTrimStr( (decimal)(AV11pClienteId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20234212275476", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?20234212275476", false, true);
      ...
      protected void SubsflControlProps_642( )
      {
         ...
         edtClienteSobreNome_Internalname = "CLIENTESOBRENOME_"+sGXsfl_64_idx;
      ...
      protected void SubsflControlProps_fel_642( )
      {
         ...
         edtClienteSobreNome_Internalname = "CLIENTESOBRENOME_"+sGXsfl_64_fel_idx;
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ClienteId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1ClienteId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
            ...
            edtClienteNome_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1ClienteId), 4, 0, ",", "")))+"'"+"]);";
            AssignProp("", false, edtClienteNome_Internalname, "Link", edtClienteNome_Link, !bGXsfl_64_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteNome_Internalname,StringUtil.RTrim( A2ClienteNome),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtClienteNome_Link,(string)"",(string)"",(string)"",(string)edtClienteNome_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteSobreNome_Internalname,StringUtil.RTrim( A3ClienteSobreNome),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteSobreNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)30,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)-1,(bool)true,(string)"SobreNome",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         lblLblclientesobrenomefilter_Internalname = "LBLCLIENTESOBRENOMEFILTER";
         edtavCclientesobrenome_Internalname = "vCCLIENTESOBRENOME";
         divClientesobrenomefiltercontainer_Internalname = "CLIENTESOBRENOMEFILTERCONTAINER";
         ...
         edtClienteSobreNome_Internalname = "CLIENTESOBRENOME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCclientesobrenome_Jsonclick = "";
         edtavCclientesobrenome_Enabled = 1;
         edtavCclientesobrenome_Visible = 1;
         ...
         divClientesobrenomefiltercontainer_Class = "AdvancedContainerItem";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLCLIENTENOMEFILTER.CLICK","{handler:'E12071',iparms:[{av:'divClientenomefiltercontainer_Class',ctrl:'CLIENTENOMEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCLIENTESOBRENOMEFILTER.CLICK","{handler:'E13071',iparms:[{av:'divClientesobrenomefiltercontainer_Class',ctrl:'CLIENTESOBRENOMEFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLCLIENTESOBRENOMEFILTER.CLICK",",oparms:[{av:'divClientesobrenomefiltercontainer_Class',ctrl:'CLIENTESOBRENOMEFILTERCONTAINER',prop:'Class'},{av:'edtavCclientesobrenome_Visible',ctrl:'vCCLIENTESOBRENOME',prop:'Visible'}]}");
         setEventMetadata("LBLCLIENTETELEFONEFILTER.CLICK","{handler:'E14071',iparms:[{av:'divClientetelefonefiltercontainer_Class',ctrl:'CLIENTETELEFONEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCLIENTEEMAILFILTER.CLICK","{handler:'E15071',iparms:[{av:'divClienteemailfiltercontainer_Class',ctrl:'CLIENTEEMAILFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E19072',iparms:[{av:'A1ClienteId',fld:'CLIENTEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV11pClienteId',fld:'vPCLIENTEID',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         lblLblclientesobrenomefilter_Jsonclick = "";
         ...
         scmdbuf = "";
         lV7cClienteNome = "";
         lV8cClienteSobreNome = "";
         lV9cClienteTelefone = "";
         lV10cClienteEmail = "";
         A6ClienteEmail = "";
         H00072_A6ClienteEmail = new string[] {""} ;
         H00072_A5ClienteTelefone = new string[] {""} ;
         H00072_A3ClienteSobreNome = new string[] {""} ;
         H00072_A2ClienteNome = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00072_A6ClienteEmail, H00072_A5ClienteTelefone, H00072_A3ClienteSobreNome, H00072_A2ClienteNome, H00072_A1ClienteId
               }
               , new Object[] {
      ...
      private int edtavCclientesobrenome_Visible ;
      private int edtavCclientesobrenome_Enabled ;
      ...
      private string divClientesobrenomefiltercontainer_Class ;
      ...
      private string AV8cClienteSobreNome ;
      private string AV9cClienteTelefone ;
      ...
      private string divClientesobrenomefiltercontainer_Internalname ;
      private string lblLblclientesobrenomefilter_Internalname ;
      private string lblLblclientesobrenomefilter_Jsonclick ;
      private string edtavCclientesobrenome_Internalname ;
      private string edtavCclientesobrenome_Jsonclick ;
      ...
      private string A3ClienteSobreNome ;
      ...
      private string edtClienteSobreNome_Internalname ;
      private string edtClienteTelefone_Internalname ;
      private string scmdbuf ;
      private string lV7cClienteNome ;
      private string lV8cClienteSobreNome ;
      private string lV9cClienteTelefone ;
      ...
      private string edtClienteSobreNome_Jsonclick ;
      ...
      private string[] H00072_A6ClienteEmail ;
      private string[] H00072_A5ClienteTelefone ;
      private string[] H00072_A3ClienteSobreNome ;
      private string[] H00072_A2ClienteNome ;
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00072( IGxContext context ,
                                             ...
                                             string AV9cClienteTelefone ,
                                             string AV10cClienteEmail ,
                                             string A2ClienteNome ,
                                             string A3ClienteSobreNome ,
                                             string A5ClienteTelefone ,
                                             string A6ClienteEmail ,
                                             short AV6cClienteId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [ClienteEmail], [ClienteTelefone], [ClienteSobreNome], [ClienteNome], [ClienteId]";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV8cClienteSobreNome)) )
         {
            AddWhere(sWhereString, "([ClienteSobreNome] like @lV8cClienteSobreNome)");
         }
         else
         {
            GXv_int1[2] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9cClienteTelefone)) )
         {
            AddWhere(sWhereString, "([ClienteTelefone] like @lV9cClienteTelefone)");
         }
         else
         {
            GXv_int1[3] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00072(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H00073(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cClienteNome",GXType.NChar,20,0) ,
          new ParDef("@lV8cClienteSobreNome",GXType.NChar,30,0) ,
          new ParDef("@lV9cClienteTelefone",GXType.NChar,20,0) ,
